        ...
        <div class="w-full mb-1">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ url('admin/kelas/all') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Kelas</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button type="button" data-modal-target="add-kelas-modal" data-modal-toggle="add-kelas-modal"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($kelas as $class)
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $class->waliKelas->email ?? 'N/A' }}</td>
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="detail-kelas-modal{{ $class->id }}"
                                            data-modal-toggle="detail-kelas-modal{{ $class->id }}"
                                        ...
                                        <button type="button" data-modal-target="edit-kelas-modal{{ $class->id }}"
                                            data-modal-toggle="edit-kelas-modal{{ $class->id }}"
                                        ...
                                        <button type="button" data-modal-target="delete-kelas-modal{{ $class->id }}"
                                            data-modal-toggle="delete-kelas-modal{{ $class->id }}"
