                    ...
                    <form action="{{ route('admin.kelas.update', $class->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="nama_kelas" value="{{ old('nama_kelas', $class->nama_kelas ?? 'N/A') }}"
                                       id="nama_kelas"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="wali_kelas"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Id Wali Kelas</label>
