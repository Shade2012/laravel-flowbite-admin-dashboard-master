        ...
        <div class="w-full mb-1">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ url('admin/guru/all') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Guru</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
            ...
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ route('admin.guru.index') }}" method="GET">
                        <label for="teacher-search" class="sr-only">Search</label>
                        <div class="relative mt-1 lg:w-64 xl:w-96">
                            <input type="text" name="name" id="teacher-search"
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button type="button" data-modal-target="add-guru-modal" data-modal-toggle="add-guru-modal"
                            ...
                            @foreach ($teacher as $guru)
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button type="button" data-modal-target="edit-guru-modal{{ $guru->id }}"
                                        ...
                                        <button type="button" data-modal-target="delete-guru-modal{{ $guru->id }}"
                                            data-modal-toggle="delete-guru-modal{{ $guru->id }}"
