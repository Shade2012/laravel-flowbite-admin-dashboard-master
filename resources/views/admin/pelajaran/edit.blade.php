                    ...
                    <form action="{{ route('admin.pelajaran.update', $lesson->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" value="{{ old('nama_pelajaran', $lesson->nama_pelajaran ?? 'N/A') }}" name="nama_pelajaran"
                                    id="nama_pelajaran"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div>
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Nama guru tidak dapat diubah.</p>
                                </div>
                            </div>
                        </div>
                </div>
