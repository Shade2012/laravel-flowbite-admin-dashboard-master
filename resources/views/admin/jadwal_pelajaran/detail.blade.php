                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('kelas', $jadwal->kelas->nama_kelas) }}" name="kelas"
                                id="kelas"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('hari', $jadwal->hari) }}"
                                name="hari" id="hari"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('jam_mulai', $jadwal->jam_mulai) }}" name="jam_mulai"
                                id="jam_mulai"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Siswa">
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('jam_selesai', $jadwal->jam_selesai) }}" name="jam_selesai"
                                id="jam_selesai"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Siswa">
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('pelajaran', $jadwal->pelajaran->nama_pelajaran) }}" name="pelajaran"
                                id="pelajaran"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Siswa">
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('guru', $jadwal->guru->user->name) }}" name="guru"
                                id="guru"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Siswa">
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input disabled="true" type="text" value="{{ old('ruang', $jadwal->ruang->nama_ruang) }}" name="ruang"
                                id="ruang"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Siswa">
                        </div>
