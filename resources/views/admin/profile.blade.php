                ...
                <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                    ...
                    <div>
                        <form method="POST" action="{{ route('photoProfile') }}"enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <img id="image-preview" class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0"
                                src="{{ $admin->image == null ? asset('static/images/users/bonnie-green-2x.png') : asset($admin->image) }}"
                                alt="Admin picture">
                        ...
                        <button type="button" data-modal-target="logout-profile-modal"
                        ...
                        <div
                            class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"id="logout-profile-modal">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                    ...
                                    <div class="p-6 pt-0 text-center">
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <div class="pt-2"></div>
                                            <svg class="mt-5 w-16 h-16 mx-auto text-red-600" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">Apakah Kamu yakin
                                                ingin keluar ? </h3>
                                            <button type="submit"
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="{{ $admin->name }}" required value="{{ old('name', $admin->name) }}">
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <label for="email"
                            ...
                            <input type="email" name="email" id="email"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="{{ $admin->email }}" required value="{{ old('email', $admin->email) }}">
                        </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            <label for="current-password"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password Saat
                                Ini</label>
                            <div class="relative">
                                <input minlength="8" name="old_password" id="current-password" type="password"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <div data-popover id="popover-password" role="tooltip"
                                class="absolute z-10 inline-block text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-100 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                                <div class="p-3 space-y-2">
                                    <h3 class="font-semibold text-gray-900 dark:text-white">Must have at least 8 characters
                                    </h3>
                                    ...
                                    <ul>
                                        <li id="min-char" class="flex items-center mb-1">
                                            <svg id="icon-min-char" class="w-4 h-4 mr-2 text-gray-300 dark:text-gray-400"
                                        ...
                                        <li id="has-symbol" class="flex items-center mb-1">
                                            <svg id="icon-has-symbol"
                                                class="w-4 h-4 mr-2 text-gray-300 dark:text-gray-400" aria-hidden="true"
                                        ...
                                        <li id="long-pass" class="flex items-center">
                                            <svg id="icon-long-pass" class="w-4 h-4 mr-2 text-gray-300 dark:text-gray-400"
                                                aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="confirm-password"
                                ...
                                password</label>
                            <div class="relative">
                                <input minlength="8" type="password" name="password_confirmation" id="confirm-password"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="••••••••" required>
