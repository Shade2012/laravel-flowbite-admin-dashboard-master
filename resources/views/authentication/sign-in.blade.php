        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
                ...
                <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <form class="mt-8 space-y-6" action="{{ route('sign-in-add') }}" method="POST">
                        ...
                        <div class="flex items-start">
                            ...
                            <a href="{{ route('forgot-password') }}"
                                class="ml-auto text-sm text-primary-700 hover:underline dark:text-primary-500">Lupa
                                Password?</a>
                        </div>
                        <button type="submit"
                            class="w-full px-5 py-3 text-base font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Masuk
                            ke akun Anda</button>
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                            Belum terdaftar? <a href="{{ route('sign-up') }}"
                                class="text-primary-700 hover:underline dark:text-primary-500">Buat akun</a>
                        </div>
                    </form>
                </div>
            </div>
