        ...
        <ul class="pb-2 space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              ...
              <li>
                <a href="{{ url('ruang') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('ruang') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Ruang
                </a>
              </li>
              <li>
                <a href="{{ url('guru') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('guru') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Guru
                </a>
              </li>
              <li>
                <a href="{{ url('siswa') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('siswa') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Siswa
              </a>
              </li>
              <li>
                <a href="{{ url('jadwal_pelajaran') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('jadwal_pelajaran') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Jadwal Pelajaran
              </a>
              </li>
            </ul>
