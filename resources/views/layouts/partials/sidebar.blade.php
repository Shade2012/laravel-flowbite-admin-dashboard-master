        ...
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Manajemen Data</span>
...
>>>>>>> 000de6bb2c6bd317e4168bb69838cdbfef1901f0
              ...
              <li>
                <a href="{{ url('admin/guru/all') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('admin/guru/all') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Guru
                </a>
              </li>
              <li>
                <a href="{{ url('admin/siswa/all') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('admin/siswa/all') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Siswa
              </a>
              </li>
            </ul>
