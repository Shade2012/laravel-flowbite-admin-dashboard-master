    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="{{ url('/') }}" class="flex ml-2 md:mr-24">
          <img src="{{ asset('static/images/logo.svg')}}" class="h-12 mr-3" alt="FlowBite Logo" />
          {{-- <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SekolahKu</span> --}}
        </a>
      ...
      <div class="flex items-center">
          ...
          <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              <a href="./profile" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
              ...
              <form action="{{ route('logout') }}" method="POST" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                @csrf
                <button type="submit">
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                ...
                <a href="./profile">
                  <img class="w-8 h-8 rounded-full" src="{{ $admin->image == null ? asset('static/images/users/bonnie-green-2x.png') : asset($admin->image) }}" alt="Admin picture">
                </a>
              </button>
            </div>
          </div>
